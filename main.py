...
class Main():
    def __init__(self, train_config, env_config, debug=False):
        ...
        process_dict = {
            'swat':[list(range(0,5)),list(range(5,16)),list(range(16,25)),list(range(25,34)),list(range(34,47)),list(range(47,51))],
        ...
        for s in range(len(process_info)): 
            for r in range(len(process_info)):
                if process_mat[s,r] !=0:
                    for m in process_info[s]:
                        for n in process_info[r]:
                            mask2[m,n] = 1
                            mask2[n,m] = 1

        self.model = Proposed(edge_index_sets, node_num = len(feature_map), process_info = process_info, mask1 = mask1,mask2=mask2,
                sensor_dim=train_config['sensor_dim'],
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sensor_dim', help='dimension', type = int, default=64)
